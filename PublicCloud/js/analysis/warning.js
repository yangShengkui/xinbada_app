(function($, doc) {
  ...
  //查询待诊断{"taskStatus":10,"categorys":"50","tickeTaskStatus":"checking,explaining","sendBeginTime":"","sendEndTime":""}
  var queryParams = {
    taskStatus: 10,
    categorys:"50",
  ...
  //工单的查询条件{"tickeTaskStatus":"","commitBeginTime":"","commitEndTime":"","categorys":"50","processedTickeTaskStatus":"checking","taskDealingStatus":"checking,explaining"}
...
//      console.log("诊断分析"+ total)
    ...
    var group = new webviewGroup(currentId, {
      ...
      items: [{
        id: "main-subpage-analysis-list-processing.html",
        url: "main-subpage-analysis-list.html",
        extras: {
        ...
        id: "main-subpage-analysis-list-processed.html",
        url: "main-subpage-analysis-list.html",
        extras: {
