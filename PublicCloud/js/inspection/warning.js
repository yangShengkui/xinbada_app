(function($, doc) {
	...
	//查询待诊断{"taskStatus":10,"sendBeginTime":"","sendEndTime":"","tickeTaskStatus":"trusting,accepting,assessing"}
	var queryParams = {
		taskStatus: 10,
		tickeTaskStatus:"trusting,accepting,assessing"
	};
	...
	//工单的查询条件{"categorys":"50","tickeTaskStatus":"","commitBeginTime":"","commitEndTime":"","processedTickeTaskStatus":"trusting","taskDealingStatus":"trusting,accepting,assessing"}
	var queryTicketParams = {
		ticketType: "normal",
		validUserFlag: true,
		processedTickeTaskStatus:"trusting",
		taskDealingStatus:"trusting,accepting,assessing"
	};
	...
	$.plusReady(function() {
		...
		var group = new webviewGroup(currentId, {
			...
			items: [{
				id: "main-subpage-inspection-list-processing.html",
				url: "main-subpage-inspection-list.html",
				extras: {
					queryStates: 3 //查询的是待诊断工单
				},
				initCallback: function() {
					//按需加载时，需要手动调用一下
					console.log("按需加载时，需要手动调用一下");
					fireAlertAndTicket()
				}
			}, {
				id: "main-subpage-inspection-list-processed.html",
				url: "main-subpage-inspection-list.html",
				extras: {
