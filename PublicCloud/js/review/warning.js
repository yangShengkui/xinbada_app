(function($, doc) {
	...
	//查询待诊断{"taskStatus":10,"categorys":"50","tickeTaskStatus":"auditing,closing","sendBeginTime":"","sendEndTime":""}
	var queryParams = {
		taskStatus: 10,
		categorys:"50",
	...
	//工单的查询条件{"tickeTaskStatus":"","commitBeginTime":"","commitEndTime":"","processedTickeTaskStatus":"auditing","taskDealingStatus":"auditing,closing"}
...
//	};
	...
	$.plusReady(function() {
		...
		var group = new webviewGroup(currentId, {
			...
			items: [{
				id: "main-subpage-review-list-processing.html",
				url: "main-subpage-review-list.html",
				extras: {
				...
				id: "main-subpage-review-list-processed.html",
				url: "main-subpage-review-list.html",
				extras: {
